...
path = 'C:\\Users\\Administrator\\Desktop\\MilkTea237\\MilkTea237\\data\\Aqualite\\DanceCube'
user_file = 'C:\\Users\\Administrator\\Desktop\\MilkTea237\\MilkTea237\\data\\Aqualite\\DanceCube\\user.pkl'
get_headers = {
...
async def get_qrcode(bot: Bot, event: Event):
    ...
    if User_qq != 1259891410:
        ...
        rd = open(user_file,'rb')
        dumpd = pickle.load(rd)
        await restart_user.send(Message(f'try'))
        await restart_user.finish(Message(f'{dumpd}'))
